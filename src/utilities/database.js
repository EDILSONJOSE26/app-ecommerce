...
const Products =[
    ...
    {name: "Vestido", price: "140", type: "Lançamento", images:[
        require("../assets/product-images/roupa/dresses_1.jpg"),
    ]},
    ...
    {name: "Teste", price: "170", type: "Lançamento", images:[
        require("../assets/product-images/roupa/dresses_2.jpg"),
    ]},
    ...
    {name: "Roupas", price: "100", type: "Lançamento", images:[
        require("../assets/product-images/nike/jordan-delta-2-sp/roupa.jpg"),
    ]},
    
    {name: "Camisa feminina", price: "80", type: "Lançamento", images:[
        require("../assets/product-images/nike/jordan-delta-2-sp/Ro.png"),
    ]},
]
